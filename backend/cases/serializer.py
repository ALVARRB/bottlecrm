...
class CaseCreateSerializer(serializers.ModelSerializer):
    ...
    def validate_name(self, name):
        if self.instance:
            if (
                ...
                raise serializers.ValidationError(_("Case already exists with this name"))
    ...
    def validate_parent(self, parent):
        ...
        if self.instance and parent.id == self.instance.id:
            raise serializers.ValidationError(_("A case cannot be its own parent."))
...
class RoutingRuleSerializer(serializers.ModelSerializer):
    ...
    def validate_conditions(self, value):
        ...
        if not isinstance(value, list):
            raise serializers.ValidationError(_("conditions must be a list of objects."))
