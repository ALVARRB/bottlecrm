# AllShopTotal CRM: Free and Open Source Customer Relationship Management
...
DATABASE_URL="postgresql://postgres:password@localhost:5432/allshoptotal?schema=public"
...
AllShopTotal CRM is open source software [licensed as MIT](LICENSE).
